##################################################
###
### Diretivas de MAKE para o construto: TesteCB
### Gerado a partir de: TesteCB.comp
###
...
$(Fobj)\testcb.obj :  {$(Pc)}\testcb.c \
    {$(Ph)}baralho.h            {$(Ph)}celulabase.h         {$(Ph)}generico.h           \
...
##################################################
###
### Fim de diretivas MAKE para o construto: TesteCB
###
##################################################
